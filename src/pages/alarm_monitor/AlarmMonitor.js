...
let subMenuMaps = {
    ...
    'alarm_monitor_analyze':AlarmAnalyze,
    'alarm_monitor_setting':AlarmSetting
};

function AlarmMonitor({ dispatch, user, gateway  }){
    let { currentMenu, userInfo } = user;
    let { treeLoading, treeData, currentNode } = gateway;
    ...
    let sidebar = (
        <div>
            ...
            {
                userInfo.agent_id && subMenu.menu_code !== 'alarm_monitor_setting'
                ?
                    ...
                    <div className={style['card-content']}>
                        {
                            ...
                            <Search 
                                ...
                                onSearch={value=>{
                                    ...
                                    } else if ( subMenu.menu_code === 'alarm_monitor_analyze' ){                                       
...
export default connect(({ user, gateway })=>({ user, gateway }))(AlarmMonitor);